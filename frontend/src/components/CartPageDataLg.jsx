        ...
        <>
            <section className="bg-black/50 z-50 fixed inset-0 ">
                <div className="bg-white w-full lg:w-[22rem] h-screen ml-auto flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto scrollbar-hidden scrollbar-hide px-3 min-h-[75vh] py-2">
                        {loading ? (
                            ...
                            <>
                                <div className="pb-4 pt-2"><div className="bg-green-200 p-2 font-medium rounded-full px-4">
                                    Total Savings: {(notDiscountPrice - totoalPrice).toFixed(2)} ₹
                                </div></div>
                            ...
                            <div className="flex flex-col items-center justify-center pt-20 sm:pt-5 lg:pt-18 text-gray-500 ">
                                <img src={NoCartData} alt="" />
                                <p className="text-lg text-black ">Your cart is empty !</p>
                                <Link
                                    to={""}
                                    className="hidden lg:block px-4 py-2 rounded bg-green-400 text-white mt-1"
                                    onClick={close}
                                >
                                    View Products
                                </Link>
                                <Link
                                    to={"/"}
                                    className="lg:hidden px-4 py-2 rounded bg-green-400 text-white mt-1 font-semibold"
                                    onClick={close}
                                >
                                    View Products
                                </Link>
