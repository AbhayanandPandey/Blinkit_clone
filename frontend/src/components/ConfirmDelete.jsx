        ...
        <div className='fixed top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center bg-black/40 backdrop-blur-sm'>
            <div className='bg-white rounded max-w-md p-4 w-full shadow-lg relative'>
                ...
                <div className='flex justify-evenly  itens-center gap-3 '>
                    ...
                    <button onClick={cancle} className="text-gray-700 hover:text-black cursor-pointer shadow-md py-1 px-3 rounded bg-green-100 hover:bg-green-200">
                        cancle
                    </button>

                    <button onClick={confirm} className="text-gray-700 hover:text-black cursor-pointer shadow-md py-1 px-3 rounded bg-red-100 hover:bg-red-200">
                        delete
                    </button>
